    ...
    <motion.div className="space-y-6" initial="hidden" animate="visible">
      ...
      {cameraOpenFor && (
        <div className="fixed inset-0 bg-black/70 flex flex-col items-center justify-center z-50">
          <video ref={videoRef} className="w-96 h-72 bg-black rounded-lg" autoPlay />
      ...
      <Card>
        ...
        <CardContent>
          {/* Inputs for visitor info unchanged */}
          <div className="mt-4">
      ...
      <div className="flex justify-end">
        <Button onClick={handleSubmit} disabled={!isFormValid || isSubmitting} className="bg-success text-white px-6 py-3">
